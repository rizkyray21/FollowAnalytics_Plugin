...
/*!
 Call this method after the FollowAnalytics initialisation only if you don't want to clear the notification center when you set the badge to 0.
 Here you can read the documentation about this behaviour.
 https://developer.apple.com/ios/human-interface-guidelines/features/notifications/
 The only solution to bypass this scenario is to send a local silent notification just after going to the background.
