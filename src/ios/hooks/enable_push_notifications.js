...
console.error("Running hook to add Push Notification entitlements");
...
module.exports = function (context) {
  ...
  fs.readdir(iosFolder, function (err, data) {
    ...
    if (fs.existsSync(destFile)) {
      ...
      var sourceFile = path.join(context.opts.plugin.pluginInfo.dir, 'src/ios/resources/PushNotification.entitlements');
      fs.readFile(sourceFile, 'utf8', function (err, data) {
        ...
        console.error("Added Push Notification entitlements to project '" + projName + "'");
